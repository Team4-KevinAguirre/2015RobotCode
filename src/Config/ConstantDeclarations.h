...
DECLARE_DOUBLE(PWM_MANIPULATOR_A, 6);
DECLARE_DOUBLE(PWM_MANIPULATOR_B, 7);
...
DECLARE_DOUBLE(ENCODER_MANIP_A, 5);
DECLARE_DOUBLE(ENCODER_MANIP_B, 5);
...
DECLARE_DOUBLE(PID_MANIP_KP,0.1)
DECLARE_DOUBLE(PID_MANIP_KI,0.0)
DECLARE_DOUBLE(PID_MANIP_KD,0.0)
